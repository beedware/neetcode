...
int main() {
    vector<string> examples = {"tickets=[[\"BUF\",\"HOU\"],[\"HOU\",\"SEA\"],[\"JFK\",\"BUF\"]]", "tickets=[[\"HOU\",\"JFK\"],[\"SEA\",\"JFK\"],[\"JFK\",\"SEA\"],[\"JFK\",\"HOU\"]]"};
    vector<string> expected = {"[\"JFK\",\"BUF\",\"HOU\",\"SEA\"]", "[\"JFK\",\"HOU\",\"JFK\",\"SEA\",\"JFK\"]"};
