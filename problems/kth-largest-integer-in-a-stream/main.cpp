...
string runExample(const string& example) {
    ...
    KthLargest obj = KthLargest(asIntValue(data[1]), constructorNums);
...
int main() {
    vector<string> examples = {"[\"KthLargest\", [3, [1, 2, 3, 3]], \"add\", [3], \"add\", [5], \"add\", [6], \"add\", [7], \"add\", [8]]"};
    vector<string> expected = {"[null, 3, 3, 3, 5, 6]"};
