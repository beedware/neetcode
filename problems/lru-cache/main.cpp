...
string runExample(const string& example) {
    ...
    LRUCache obj = LRUCache(asIntValue(data[1]));
...
int main() {
    vector<string> examples = {"[\"LRUCache\", [2], \"put\", [1, 10],  \"get\", [1], \"put\", [2, 20], \"put\", [3, 30], \"get\", [2], \"get\", [1]]"};
    vector<string> expected = {"[null, null, 10, null, null, 20, -1]"};
