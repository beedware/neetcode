...
int main() {
    vector<string> examples = {"[\"WordDictionary\",\"addWord\",\"addWord\",\"addWord\",\"search\",\"search\",\"search\",\"search\"]\n[[],[\"day\"],[\"bay\"],[\"may\"],[\"say\"],[\"day\"],[\".ay\"],[\"b..\"]]"};
    vector<string> expected = {"[null, null, null, null, false, true, true, true]"};
