...
int main() {
    vector<string> examples = {"[\"PrefixTree\", \"insert\", \"apple\", \"search\", \"apple\", \"search\", \"app\", \"startsWith\", \"app\", \"insert\", \"app\", \"search\", \"app\"]"};
    vector<string> expected = {"[null, null, true, false, true, null, true]"};
